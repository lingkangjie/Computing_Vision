...
int main(int argc, char** argv)
{
	...
	// for debug, I add a video path to the command argument:
	// D:\tmp\opencv-3.4.5\samples\data\tree.avi
	//method: right-click the project,properties,Debugging,Command Arguments,and paste
	// "D:\tmp\opencv-3.4.5\samples\data\tree.avi" exactly as the "video" argument just
